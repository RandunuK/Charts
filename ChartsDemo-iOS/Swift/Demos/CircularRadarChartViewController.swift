...
class CircularRadarChartViewController: DemoBaseViewController {

    @IBOutlet var chartView: CircularRadarChartView!
...
extension CircularRadarChartViewController: IAxisValueFormatter {
